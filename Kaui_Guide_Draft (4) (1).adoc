...
| External key
| An optional alternate ID for the account.
...
| Billing cycle day
| For monthly or quarterly subscriptions, what day of the month the invoice is created. Once this is set and saved for the customer, you cannot change it.

| Currency
| The currency that the customer uses to make purchases.

| Timezone
| The time zone in which the customer resides. Once this is set and saved for the customer, you cannot change it.
...
1. Search for the account using basic search or advanced search.

2. On the Account page, next to "Account Information," click *Edit*.
